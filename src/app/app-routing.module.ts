...
const routes: Routes = [
  ...
  { path: 'editEmpleado/:id', component: CreateEmpleadoComponent,canActivate: [AuthGuard] },
  { path: 'editSituacionIVA/:id', component: CreateIvaComponent,canActivate: [AuthGuard] },
  { path: 'editUsuario/:id', component: CreateUsuarioComponent,canActivate: [AuthGuard] },
